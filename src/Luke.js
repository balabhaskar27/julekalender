...
const stengtLukeBeskjed = ( post, stengtLuke, lukenr ) => {
  let beskjed = <div className="luke-beskjed"><i>Send inn svaret til <a href={`mailto:julekalender@offerspill.no?subject=Luke ${lukenr}`}>julekalender@offerspill.no</a> innen midnatt. Hver løste luke gir ett lodd i trekningen om et brett signert av Magnus Carlsen.</i></div>;
